...
public class IntroLab {
    ...
    /**
     * Returns a message generated by printLabMessage.
     */
    public static String tenenb19() {
        return printLabMessage("Hello", "Leo Tenenbaum", true, "Here is a message.");
    }
